...
public class EbookManagementServlet extends HttpServlet {
   ...
   int[] price={100,299,78,69,20,120,100};
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                out.println("<!DOCTYPE html><html><head><title>EbookManagement</title><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><link rel=\"stylesheet\" href=\"style.css\"/></head><body><header><h class=\"header-head\">Welcome to Ebook Management</h></header><button id=\"cart_butt\">Nothing in cart</button><div class=\"books\">");
                if(books.length==0){
                    out.println("<p class=\"header-head\">No Books Found!!!</p>");
                }
                else{
                    for(int i=0;i<books.length;i++){
                        ...
                        out.println("<button onclick=\"call(this)\" data-value=\""+books[i]+"\"class=\"cart-butt\">Add To Cart</button>");
                        out.println("</div>");
                    }
                }
                out.println("</div>");
